...
async def start_yuichi():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@NIGHT_FUN_XD"))
            await idk(functions.channels.JoinChannelRequest(channel="@NIGHT_FUN_XD"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@Officialyuichi"))
            await ydk(functions.channels.JoinChannelRequest(channel="@OfficialyuichiSupport"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@Officialyuichi"))
            await wdk(functions.channels.JoinChannelRequest(channel="@OfficialyuichiSupport"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@Officialyuichi"))
            await hdk(functions.channels.JoinChannelRequest(channel="@OfficialyuichiSupport"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@Officialyuichi"))
            await sdk(functions.channels.JoinChannelRequest(channel="@OfficialyuichiSupport"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@Officialyuichi"))
            await adk(functions.channels.JoinChannelRequest(channel="@OfficialyuichiSupport"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@Officialyuichi"))
            await bdk(functions.channels.JoinChannelRequest(channel="@OfficialyuichiSupport"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@Officialyuichi"))
            await cdk(functions.channels.JoinChannelRequest(channel="@OfficialyuichiSupport"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@Officialyuichi"))
            await ddk(functions.channels.JoinChannelRequest(channel="@OfficialyuichiSupport"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@Officialyuichi"))
            await edk(functions.channels.JoinChannelRequest(channel="@OfficialyuichiSupport"))
...
loop.run_until_complete(start_yuichi())       
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        yuichi = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)     
        if len(e.text) > 5:
            bio = str(yuichi[0])
            text = "Changing Bio"
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(yuichi) == 2:
            message = str(yuichi[1])
            counter = int(yuichi[0])
            if counter > 100:
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        smex = await e.get_reply_message()
        yuichi = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        yuichisexy = yuichi[1:]
        if len(yuichisexy) == 2:
            message = str(yuichisexy[1])
            counter = int(yuichisexy[0])
            sleeptime = float(yuichi[0])
            for _ in range(counter):
...
async def _(e):
    global que
    usage = "𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲 = 𝗥𝗲𝗽𝗹𝘆𝗥𝗮𝗶𝗱\n\nCommand:\n\n.raidop <Username of User>\n\n.raidop <reply to a User>"
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        yuichi = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
...
@idk.on(events.NewMessage(incoming=True, pattern=r"\.draidop"))
@ydk.on(events.NewMessage(incoming=True, pattern=r"\.draidop"))
@wdk.on(events.NewMessage(incoming=True, pattern=r"\.draidop"))
@hdk.on(events.NewMessage(incoming=True, pattern=r"\.draidop"))
@sdk.on(events.NewMessage(incoming=True, pattern=r"\.draidop"))
@adk.on(events.NewMessage(incoming=True, pattern=r"\.draidop"))
@bdk.on(events.NewMessage(incoming=True, pattern=r"\.draidop"))
@cdk.on(events.NewMessage(incoming=True, pattern=r"\.draidop"))
@edk.on(events.NewMessage(incoming=True, pattern=r"\.draidop"))
@ddk.on(events.NewMessage(incoming=True, pattern=r"\.draidop"))
async def _(e):
    global que
    usage = "𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲 = 𝗗𝗲𝗮𝗰𝘁𝗶𝘃𝗮𝘁𝗲 𝗥𝗲𝗽𝗹𝘆𝗥𝗮𝗶𝗱\n\nCommand:\n\n.draidop <Username of User>\n\n.draidop <reply to a User>"
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        yuichi = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
...
print(text)
print("")
print("SMEX! BOT IS READY GO AND FUCK NEXUS.")
